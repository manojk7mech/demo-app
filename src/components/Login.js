...
const Login = ({ loggedIn, setLoggedIn, setCookie }) => {
    ...
    return (
        <div className="dark:bg-gray-700">
            <h3 className="text-center mt-2 text-lg text-gray-500 font-semibold block p-1">Login...</h3>
            ...
            <label htmlFor="email">Email</label>
                ...
                <button className="focus:ring-2 focus:ring-opacity-50 focus:ring-offset-2 focus:ring-blue-500 focus:ring-offset-blue-600 block p-2 mt-3 m-2 mx-auto w-full text-xl font-bold rounded-md text-blue-700 bg-gray-200 focus:outline-none tracking-wide" type="submit"
                    onClick={handleLogin}
                >Login</button>
            </form>
        </div>
