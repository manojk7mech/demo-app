    ...
    return (
        <div className="flex justify-center items-center md:justify-between max-w-screen-lg mx-auto transform duration-300 ease-in">
            <div className="mx-3 my-1 flex items-center text-center cursor-pointer">
                <Link to="/">
                    <img className="h-16" src="/images/miconblue.png" alt="Logo" />
                </Link>
            ...
            <div className="flex-col justify-center p-2">
                ...
                <div onClick={() => setDarkEnabled(!darkEnabled)} className="mx-auto my-2 hidden md:flex h-5 w-11 bg-gray-300 dark:bg-gray-600 ring-2 dark:ring-green-400 ring-blue-700 rounded-full cursor-pointer transform transition-transform duration-200 ease-in-out">
