...
const TopNavbar = (props) => {
    ...
    const { darkEnabled, setDarkEnabled, loggedIn, setLoggedIn, theUser, removeCookie } = props;

    return (
        <>
            { openModal ? 
                <ConfirmLogout closeModal={setOpenModal} setLoggedIn={setLoggedIn} removeCookie={removeCookie} />
            : (
