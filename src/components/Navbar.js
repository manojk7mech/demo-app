                    ...
                    { isShow ?
                        <> 
                            <div className="flex items-center justify-items-end">
                                <XIcon onClick={() => setIsShow(!isShow)} className="h-7 w-7 mx-auto cursor-pointer text-gray-800 dark:text-gray-100" fill="currentColor" viewBox="0 0 24 24" stroke="none" />
                        ...
                        <div className="flex items-center">
                            <MenuIcon onClick={() => setIsShow(!isShow)} className="h-7 w-7 mx-auto cursor-pointer text-gray-800 dark:text-gray-100" fill="currentColor" viewBox="0 0 24 24" stroke="none" />
